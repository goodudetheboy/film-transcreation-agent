...
the score is synthesized in JavaScript, and the only external media are short
...
| `scripts/generate-score.mjs` | Deterministic score synth (pads, Karplus–Strong plucks, impacts, reverb). Cut points mirror the scene list, so change both together |
